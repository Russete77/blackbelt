  ...
  return (
    <span className={cn("relative inline-flex", className)}>
      <button
        ...
        className="grid h-4 w-4 shrink-0 place-items-center rounded-full text-muted transition-colors duration-200 hover:text-fg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
      >
      ...
      <span
        ...
        role="tooltip"
        className={cn(
          "pointer-events-none absolute bottom-full left-1/2 z-50 mb-1.5 w-52 -translate-x-1/2 rounded-md border border-line",
